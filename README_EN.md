...
1. **Download Package**
   ...
   - Download the latest version `xhs-collector-beta-v1.0.1.zip`
   - Or direct download: [xhs-collector-beta-v1.0.1.zip](https://github.com/fancyyan/xiaohongshu-content-collector/releases/download/v1.0.1/xhs-collector-beta-v1.0.1.zip)
